...
import { UbicacionComponent } from '../../../components/configuracion/ubicacion/ubicacion';
...
export class EstablecimientoPage {
  ...
  ArrayConfiguracionEST = [
    ...
    , {id: 3 , titulo: "Imagenes", iconName: "images", activo: false, component: UbicacionComponent}
